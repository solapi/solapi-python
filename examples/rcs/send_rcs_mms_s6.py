...
if __name__ == '__main__':
  res = storage.uploadRCSImage('./images/sample1.png').json()
  sample1 = res['fileId']
  res = storage.uploadRCSImage('./images/sample2.png').json()
  sample2 = res['fileId']
  res = storage.uploadRCSImage('./images/sample3.png').json()
  sample3 = res['fileId']
  res = storage.uploadRCSImage('./images/sample4.png').json()
  sample4 = res['fileId']
  res = storage.uploadRCSImage('./images/sample5.png').json()
  sample5 = res['fileId']
  res = storage.uploadRCSImage('./images/sample6.png').json()
  sample6 = res['fileId']
          ...
          'additionalBody': [
            {
              ...
              'buttons': [ { 'buttonType': 'WL', 'buttonName': '버튼1', 'link': 'https://nurigo.net' }, { 'buttonType': 'WL', 'buttonName': '버튼2', 'link': 'https://nurigo.net' } ]
            },
            {
              'imageId': sample3,
              'title': 'Sample 3',
